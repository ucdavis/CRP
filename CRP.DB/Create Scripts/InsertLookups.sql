...
GO
INSERT INTO [dbo].[Validators]([Name], [Class], [RegEx], [ErrorMessage])
  VALUES('Date', 'date', '^(((0?[1-9]|1[012])[-\/](0?[1-9]|1\d|2[0-8])|(0?[13456789]|1[012])[-\/](29|30)|(0?[13578]|1[02])[-\/]31)[-\/](19|[2-9]\d)\d{2}|0?2[-\/]29[-\/]((19|[2-9]\d)(0[48]|[2468][048]|[13579][26])|(([2468][048]|[3579][26])00)))$', '{0} is not a valid date.')
GO
INSERT INTO [dbo].[Validators]([Name], [Class], [RegEx], [ErrorMessage])
