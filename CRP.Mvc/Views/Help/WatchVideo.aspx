...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <param name="flashvars" value="author=CRP&amp;file=http://v.caes.ucdavis.edu/CRP/Video/<%=Html.Encode(Model.VideoName)%>.flv&amp;
    image=http://v.caes.ucdavis.edu/CRP/Video<%=Html.Encode(Model.VideoName)%>.jpg&amp;
    plugins=captions-1,audiodescription-1">
    <embed type="application/x-shockwave-flash" id="single2" name="single2" src="http://v.caes.ucdavis.edu/JWPlayer/player.swf" bgcolor="undefined" allowscriptaccess="always" allowfullscreen="true" wmode="transparent" flashvars="author=ASI&amp;file=http://v.caes.ucdavis.edu/CRP/Video/<%=Html.Encode(Model.VideoName)%>.flv&amp;
    image=http://v.caes.ucdavis.edu/CRP/Video/<%=Html.Encode(Model.VideoName)%>.jpg&amp;
