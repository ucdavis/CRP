...
<%@ Import Namespace="CRP.Controllers" %>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#file").bt('The maximum picture size is 4 meg. It must have an aspec ratio of 16:9 (1200x675 preferred).  A free online resize tool can be found at: http://www.picresize.com/ This one is a little better for cropping if you need to change the aspect ratio: http://resizeimage.net/');
