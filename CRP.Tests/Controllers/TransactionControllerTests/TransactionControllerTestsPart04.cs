...
namespace CRP.Tests.Controllers.TransactionControllerTests
{
    ...
    public partial class TransactionControllerTests
    {
        ...
        public void TestCheckoutPostRedirectsToHomeControllerIfItemNotFound()
        {
            ...
            #region Act
            Controller.Checkout(1, null, 1, null, null, "Check", string.Empty, string.Empty, null, null, true)
        ...
        public void TestCheckoutPostRedirectsToHomeControllerIfItemIsNotAvailable1()
        {
            ...
            #region Act
            Controller.Checkout(2, null, 1, null, null, "Check", string.Empty, string.Empty, TransactionAnswerParameters, null, true)
                .AssertActionRedirect()
                .ToAction<HomeController>(a => a.Index());
            #endregion Act
        ...
        public void TestCheckoutPostDoesNotRedirectToHomeControllerIfItemIsNotAvailableButAdmin4()
        {
            ...
            #region Act
            Controller.Checkout(2, null, 1, null, (Items[1].CostPerItem * 1), "Check", string.Empty, string.Empty, TransactionAnswerParameters, null, true)
                .AssertActionRedirect()
        ...
        public void TestCheckoutWithFalseRecaptchDoesNotSave()
        {
            ...
            #region Act
            Controller.Checkout(2, null, 1, null, (Items[1].CostPerItem * 1), "Check", string.Empty, string.Empty, TransactionAnswerParameters, null, false)
                .AssertViewRendered()
        ...
        public void TestCheckoutWithDonationCreatesChildTransaction()
        {
            ...
            #region Act
            Controller.Checkout(2, null, 1, 25.01m, (Items[1].CostPerItem * 1) + 25.01m, "Check", string.Empty, string.Empty, TransactionAnswerParameters, null, true)
                .AssertActionRedirect()
                .ToAction<TransactionController>(a => a.Confirmation(1));
            #endregion Act
        ...
        public void TestCheckoutWithCheckOrCreditNotSpecifiedDoesNotSave()
        {
            ...
            #region Act
            Controller.Checkout(2, null, 1, null, (Items[1].CostPerItem * 1), string.Empty, string.Empty, string.Empty, TransactionAnswerParameters, null, true)
                .AssertViewRendered()
                .WithViewData<ItemDetailViewModel>();
            #endregion Act
